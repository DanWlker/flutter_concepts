...
33. Dart follows the Uniform access principle, which makes [fields indistinguishable from getters and setters](https://dart.dev/null-safety/understanding-null-safety#abstract-fields), this causes the null safety promotion to not occur for fields. Also this is about the abstract keyword for fields cuz of null safety but yeah
